...
import { Caveat, DM_Sans, Ranchers, Space_Mono, Noto_Sans_SC, Noto_Sans_Arabic } from 'next/font/google';
...
export default async function RootLayout({
  ...
  return (
    <html lang={locale} dir={locale === 'ar' ? 'rtl' : 'ltr'} className="h-full antialiased">
      <body className={`${dmSans.variable} ${ranchers.variable} ${spaceMono.variable} ${notoSC.variable} ${notoArabic.variable} font-sans bg-bdi-cream text-bdi-dark min-h-full flex flex-col`}>
