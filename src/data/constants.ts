...
export const BUREAU_MEMBERS: BureauMember[] = [
    ...
    { name: "Fadi", role: "Trésorière", photo: "/members/fadi.jpeg" },
    {
        name: "Fernanda",
        role: "Secrétaire Générale",
        photo: "/members/fernanda.jpeg",
    },
    { name: "Runjia", role: "Communication", photo: "/members/runjia.jpeg" },
    { name: "Cosmin", role: "Events", photo: "/members/cosmin.jpeg" },
    { name: "Rafael", role: "Events", photo: "/members/rafael.jpeg" },
    {
        name: "Federico",
